    ...
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-4 border-b border-gray-800/50">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-white font-semibold text-lg">DeFiDAO</span>
        </div>
      ...
      <div className="relative z-10 flex items-center justify-between px-6 py-20 max-w-7xl mx-auto">
        <div className="flex-1 max-w-2xl">
          ...
          <p className="text-gray-300 text-lg md:text-xl leading-relaxed mb-8 max-w-xl">
            DeFiDAO is a powerful platform to build and deploy DeFi protocols and DAO governance systems. It comes with
            advanced tooling and supports all major blockchains with a growing library of DeFi primitives.
          </p>
          ...
          {/* Social Proof */}
          <div className="mt-16">
            <p className="text-gray-500 text-sm mb-4">Used by leading DeFi development teams</p>
