...
export class FusionSwapComponent extends BridgeComponent {
  ...
  readonly metadata: ComponentMetadata = {
    category: 'DeFi',
    tags: ['swap', 'fusion', 'gasless', 'mev-protection', '1inch'],
    version: '1.0.0',
    author: 'Unite DeFi',
    documentation: 'https://docs.1inch.io/docs/fusion-protocol',
    examples: [
      {
  ...
  async test(inputs: Record<string, any>): Promise<ComponentExecutionResult> {
    try {
      // For testing, we'll simulate a Fusion swap
      const mockResult = {
  ...
  private async executeFusionSwap(inputs: Record<string, any>): Promise<any> {
    // This would be the actual Fusion swap implementation
